...
echo "============================================================"
echo -e "${COLOR_NONE}"
LIST_OF_APPS="nginx php5-common php5-mysql php5-mysqlnd php5-xmlrpc php5-curl php5-gd php5-cli php5-fpm php-pear php5-dev php5-imap php5-mcrypt mysql-server mysql-client phpmyadmin "
